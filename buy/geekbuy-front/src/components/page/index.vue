    ...
    <div>
        ...
        <app-body>
            ...
            <el-tabs v-model="labelName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="显卡" name="1"></el-tab-pane>
                <el-tab-pane label="主板" name="2"></el-tab-pane>
                <el-tab-pane label="CPU" name="3"></el-tab-pane>
                <el-tab-pane label="电源" name="4"></el-tab-pane>
                <el-tab-pane label="其他" name="5"></el-tab-pane>
            </el-tabs>
            <el-button class="extra-button" type="primary" icon="el-icon-cpu" @click="start">不会选二手配件？即刻，启动！</el-button>
